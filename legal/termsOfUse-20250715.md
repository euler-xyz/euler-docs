...
Welcome\! These Terms of Use (“Terms”) govern your access to and use of the products, services, website and related information and materials (collectively, the “Products”) offered by The Euler Foundation or its affiliates (“Company,” “we,” “us,” or “our”), which includes euler.finance, app.euler.finance and the interface and related services that facilitate interaction with the Euler Protocol (the “Protocol”), and any other interaction or engagement with us. You understand and acknowledge that the Protocol is not a Product and we do not control the Protocol. See Section 4 below titled “Products vs. Protocol” for an overview.
...
**3.5   No Affiliation with Telegram**
...
The Products allow users to use the Protocol to create and deploy custom smart contract components (see  “Components” above) to facilitate transactions of digital assets, such as, but not limited to, Vaults, Pools, and Operators. The Company does not control, influence, permission or monitor the design, parameters, or operation of any Components created by any party using the Products or otherwise created. All Components are entirely user-generated, and the Company bears no responsibility for any aspect of their creation, management, or outcomes.
...
* You are solely responsible to conduct thorough due diligence before interacting with any Component. The Company makes no representations or warranties regarding the security, reliability, or performance of any Components and does not endorse, review, or vet any Components deployed by third parties.
...
You represent and warrant that you will not access or use the Products from any jurisdiction where such access or use is prohibited by applicable law, regulation, or by any restrictions imposed by Euler or The Euler Foundation, including but not limited to those relating to financial promotions regimes or similar legal frameworks. Certain communications, functionalities, or sections of the website or Products may not be made available to persons located in certain jurisdictions, except where a valid exemption applies.

You further agree not to use any virtual private network (“VPN”), proxy service, or other method or technology to conceal your location or to circumvent any geographic or jurisdictional restrictions imposed by Euler or The Euler Foundation. Any such circumvention constitutes a breach of these Terms and may result in immediate termination of access and potential legal consequences.
...
You hereby agree and affirm that you are not a “Sanctioned Person” or accessing the Products or Protocol on behalf of, for the benefit of, or at the direction of any Sanctioned Person. For purposes of this Section, a Sanctioned Person is any of the following:
...
Fees may also be paid to third parties who use the Products to create or configure assets, products, or services, or to the Euler DAO, as further described in the Euler Docs (here: [https://github.com/euler-xyz/fee-flow/blob/main/docs/whitepaper.md](https://github.com/euler-xyz/fee-flow/blob/main/docs/whitepaper.md) and here: [http://docs.euler.finance/](http://docs.euler.finance/)) and fee flow documentation, depending on the specific implementation. Users are responsible for reviewing the fee structure applicable to each Product or Component with which they interact. 
...
This Section applies whether you access the Protocol directly or via a Product operated by the Company, such as its web interface or Telegram Mini App. All transactions are final and irreversible, even if made in error or resulting from unauthorised access.
...
Some Products will allow you to download and/or use software components to facilitate your use of the Products and Protocol. We provide access to these components through our GitHub repository (located at: [https://github.com/euler-xyz](https://github.com/euler-xyz/ethereum-vault-connector)). By downloading and/or using any of the software components we provide, you agree to abide by any additional licence terms. As of the “Last Updated” date, this includes the following:
...
* EPO (Euler Price Oracle): [https://github.com/euler-xyz/euler-price-oracle/blob/master/LICENSE](https://github.com/euler-xyz/euler-price-oracle/blob/master/LICENSE)
...
* EulerSwap: [https://github.com/euler-xyz/euler-swap/blob/master/LICENSE](https://github.com/euler-xyz/euler-swap/blob/master/LICENSE) 

* EulerEarn: [https://github.com/euler-xyz/euler-earn/blob/master/LICENSE](https://github.com/euler-xyz/euler-earn/blob/master/LICENSE)

**12\.   Privacy**

**12.1   Data Collection**

We collect and use your personal data in accordance with our Privacy Policy. By using the Products, you consent to the collection, use, and sharing of your data as described in the [Privacy Policy](https://www.euler.finance/privacy-policy).
