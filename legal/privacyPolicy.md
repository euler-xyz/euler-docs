...
Euler and The Euler Foundation are committed to protecting and respecting your privacy. This Privacy Policy (the Policy) describes how Euler and its affiliates ("we", "us", or "our"), might collect, use, and/or share your personal data when you access our company websites, including but not limited to, [euler.finance](https://www.euler.finance) (including the Euler app) and its sub-domains, and [euler.foundation](http://euler.foundation) and its sub-domains, and all of our other Sites, properties, products, and services (the Services).

Euler is also committed to the principle of data minimization. This means that we only collect the personal data that is necessary to provide, maintain, and improve our Services. We do not collect any more information than is required for these purposes. By limiting our data collection to the essential information needed to operate effectively, we aim to protect your privacy while delivering the best possible experience.

For the purposes of this Policy, personal data is any data related to an identified or identifiable individual.

Your use of the Services is subject to this Policy as well as our Terms of Use. If you do not agree with the terms of this Policy, do not access or use these Services, or any other aspect of our business.
...
**User support.** We may use the data we collect to provide you with support and to answer any requests you may have about the Services.
...
**We do not share your personal data with any third parties** without seeking your consent. But we may share or disclose the data we collect in the limited circumstances as described below:

1. With regulators, government entities, and law enforcement to comply with our legal obligations

2. With service providers and vendors who may assist us in providing, delivering, and improving the Services (hosting provider, mailing provider, etc)

3. With blockchain security analytics providers to ensure the safety and security of our Services and to screen your wallet for any prior illicit activity

4. To enforce your agreements with us, including this Privacy Policy, and to respond to claims that your use of the Service violates any third-party rights
...
- Withdraw any consent you provided to us to process your personal data; please note that we may continue to process your personal data despite this opposition for legitimate reasons or for the defence of legal claims.
- File a complaint to a statutory authority and such other rights as may be relevant under applicable laws.

### CCPA Compliance:

- **Privacy Practices:** We do not engage in the sale of personal information as defined by the CCPA. Refer to the 'Sharing and Disclosure of Information' section above for more details about the types of third parties with whom we may share your information.

- **Privacy Rights:** Under the CCPA, individuals have the right to request details about how their personal information has been collected, used, and shared. You can also request a copy of any information we might hold about you, or ask us to delete any personal information we have collected. However, please note that the CCPA places certain limits on these rights, such as restricting the provision of sensitive information in response to access requests and defining the conditions under which we must comply with a deletion request. We will fulfil requests for information, access, and deletion to the extent we can reasonably link the information we have with the identifying details you provide. If a request is denied, we will inform you of our decision. You have the right to exercise these rights without facing any discrimination.

- **Submitting a Request:** To request information, access, or deletion of your personal data, please contact us at contact@euler.foundation

- **Identity Verification:** The CCPA mandates that we verify the identity of any individual making a request to access or delete personal information before we can provide a substantive response.

- **Authorised Agents:** California residents may designate an 'authorised agent' to submit requests on their behalf. We will require the authorised agent to have written authorization confirming their authority to act on your behalf.

### GDPR Compliance:

- **Data Processing Purposes:** We process personal data for the purposes outlined in the 'How We Use Data' section above. Our legal grounds for processing your data include: (i) your consent to processing by us or our service providers for one or more specific purposes; (ii) processing is necessary for fulfilling a contract with you; (iii) processing is required to comply with a legal obligation; and/or (iv) processing is necessary for the legitimate interests pursued by us or a third party, provided your fundamental rights and freedoms do not override these interests.

- **GDPR Rights:** Under the General Data Protection Regulation (GDPR), you have the right to (i) request access to and obtain a copy of your personal data, (ii) request corrections or deletion of your personal data, (iii) object to or limit the processing of your personal data, and (iv) request the transferability of your personal data. Additionally, you may withdraw your consent to our data collection at any time. However, please be aware that we cannot modify or delete information stored on a blockchain. Data such as transaction details, blockchain wallet addresses, and assets held at your address that may be related to the data we collect are beyond our control.

- **Exercising GDPR Rights:** To exercise any of your rights under GDPR, please reach out to us at contact@euler.foundation. We may require additional information from you to process your request. Please note that we may retain information as necessary to fulfil the original purpose for which it was collected, and we may continue to retain it even after a data subject request, in accordance with our legitimate interests, which include compliance with legal obligations, dispute resolution, fraud prevention, and enforcement of our agreements.

To exercise these rights, you can write to us at contact@euler.foundation. We will respond to your request in accordance with applicable regulations and law.

You may opt-out of direct marketing communications by writing to us at contact@euler.foundation.
...
We retain your personal data only for as long as necessary to fulfil the purposes for which it was collected, considering the nature, amount, and sensitivity of the data. We also consider legal, regulatory, tax, accounting, or reporting requirements to determine the appropriate retention period.
