...
Governance Forum → eIP (Euler Improvement Proposal) → Create Proposal on Snapshot → Off-chain Voting → Create Proposal on Tally → On-chain Voting and Execution

https://governance.euler.finance/
